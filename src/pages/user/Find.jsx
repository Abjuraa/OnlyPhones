                    ...
                    <div className="flex min-w-[300px]">
                        <div className="flex flex-col w-full pb-3">
                            ...
                            <div className="flex w-full justify-center py-3 px-3">
                                <button type="button" className="flex bg-slate-200 w-full justify-center items-center gap-2 py-2 rounded-xl text-sm font-semibold hover:bg-slate-300 transition duration-300 ease-in-out"> <IconLocation /> Cómo llegar</button>
                            </div>
                        </div>
                    </div>
                </div>
